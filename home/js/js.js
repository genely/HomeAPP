$(document).ready(function() {
    ...
    //拖动
    $("#wrap-home-title").mousedown(function(event) {
        var isMove = true;
        var abs_x = event.pageX - $('div.wrap-home').offset().left;
        var abs_y = event.pageY - $('div.wrap-home').offset().top;
        $(document).mousemove(function(event) {
            if (isMove) {
                var obj = $('div.wrap-home');
    ...
    //窗口缩放
    var oDiv = document.getElementById('wrap-home');
